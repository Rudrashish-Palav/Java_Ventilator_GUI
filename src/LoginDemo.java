       ...
       /* user_label = new JLabel("Username :");
        ...
        //image
	     ImageIcon icon = new ImageIcon("login1.png");
	      ...
	      Image newimg = img.getScaledInstance( 150+i, 100,  java.awt.Image.SCALE_SMOOTH ) ;  
	      icon = new ImageIcon( newimg );
	     JLabel image = new JLabel();
	     image.setIcon(icon);
	     image.setBounds(175,10,250+i,120);
        ...
        password_text.setBounds(200,150,250+i,30);
...
//            message.setText(" Hello ");
            int dialoginput=JOptionPane.showConfirmDialog(this,"Do you really want to delete data?","Confimation!!",JOptionPane.YES_NO_OPTION);
            if(dialoginput==0) {
            	new DDFrame();
                dispose();
                keyboard.dispose();
